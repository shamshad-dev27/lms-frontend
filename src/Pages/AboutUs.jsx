 ...
 return(
    <HomeLayout>
       ...
       <div className="flex items-center py-10">
        ...
        <h1 className="text-5xl text-yellow-500 font-semibold">Affordable and quality <span>education</span></h1>
        ...
        <div className="w-1/2 ">
        <img className="drop-shadow-2xl w-[60%] m-auto " id="text1" style={{
